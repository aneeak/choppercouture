...
const PIECES: Piece[] = [
  ...
  // Neuer Schwung, Modellaufnahmen und getragene Pieces
  { src: `${DIR}/dsc00810.jpg`, cap: "CC", alt: "Einzelner Zahn mit Grillz, Gipsmodell, Chopper Couture Berlin" },
  { src: `${DIR}/dsc00811.jpg`, cap: "CC", alt: "Grillz auf einem Zahn, Unterkiefermodell, Dental Jewelry Berlin" },
  { src: `${DIR}/dsc00812.jpg`, cap: "CC", alt: "Einzelzahn-Grillz aus CoCr, Gipsmodell Chopper Couture" },
  { src: `${DIR}/dsc00814.jpg`, cap: "CC", alt: "Grillz an den Frontzähnen, Modellansicht, Chopper Couture" },
  { src: `${DIR}/dsc00815.jpg`, cap: "CC", alt: "Single-Tooth Grillz poliert, Dental Jewelry Berlin" },
  { src: `${DIR}/dsc00816.jpg`, cap: "CC", alt: "Einzelzahn-Piece auf Gipsmodell, Chopper Couture Berlin" },
  { src: `${DIR}/dsc00817.jpg`, cap: "CC", alt: "Spitzes Grillz-Set Oberkiefer, handgefertigt in Berlin" },
  { src: `${DIR}/dsc00819.jpg`, cap: "CC", alt: "Grillz über mehrere Zähne, kantiges Design, Chopper Couture" },
  { src: `${DIR}/dsc00822.jpg`, cap: "CC", alt: "Grillz-Set Unterkiefer, Dental Jewelry aus CoCr-Legierung" },
  { src: `${DIR}/dsc00823.jpg`, cap: "CC", alt: "Vollständiges Grillz-Set auf Gipsmodell, Chopper Couture Berlin" },
  { src: `${DIR}/dsc00828.jpg`, cap: "CC", alt: "Dezentes Grillz am Modell, Custom Dental Jewelry" },
  { src: `${DIR}/dsc00830.jpg`, cap: "CC", alt: "Zweizahn-Grillz, individuell gefertigt, Chopper Couture" },
  { src: `${DIR}/dsc00833.jpg`, cap: "CC", alt: "Offenes Rahmen-Grillz Ober- und Unterkiefer, Berlin" },
  { src: `${DIR}/dsc00837.jpg`, cap: "CC", alt: "Rahmen-Grillz im Detail, handgefertigtes Unikat" },
  { src: `${DIR}/dsc00839.jpg`, cap: "CC", alt: "Filigranes Grillz Unterkiefer, Chopper Couture Berlin" },
  { src: `${DIR}/dsc00849.jpg`, cap: "CC", alt: "Ornamentales Grillz auf Gipsmodell, Dental Jewelry Berlin" },
  { src: `${DIR}/dsc00852.jpg`, cap: "CC", alt: "Verspieltes Rahmen-Grillz, Custom Design Chopper Couture" },
  { src: `${DIR}/dsc04120.jpg`, cap: "CC", alt: "Grillz getragen, Custom Dental Jewelry aus Berlin" },
  { src: `${DIR}/dsc04122.jpg`, cap: "CC", alt: "Grillz im Mund, handgefertigt von Chopper Couture" },
  { src: `${DIR}/dsc04134.jpg`, cap: "CC", alt: "Getragenes Grillz-Set, Dental Jewelry Berlin" },
  { src: `${DIR}/dsc04140.jpg`, cap: "CC", alt: "Grillz Nahaufnahme getragen, Chopper Couture Berlin" },
  { src: `${DIR}/dsc04157.jpg`, cap: "CC", alt: "Custom Grillz im Alltag, Dental Jewelry Chopper Couture" },
  { src: `${DIR}/ornamental-grillz.jpg`, cap: "CC", alt: "Ornamentales Grillz mit Steinen, Chopper Couture Berlin" },
];
